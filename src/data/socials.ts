...
export const getWhatsappShopNowLink = (name?: string) => {
  let message = "";
  if (name)
    message = `Hey, I'm interested in ordering the ${name} bandana. Can you help me placing an order?`;
  else
    message = `Hey, I'm interested in ordering a bandana. Can you help me placing an order?`;
